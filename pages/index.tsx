          ...
          <header className="text-gray-700 body-font border-b border-gray-200">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
              ...
              <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                ...
                <a className="mr-5 hover:text-gray-900">Admissions</a>
                <a className="mr-5 hover:text-gray-900">Acedamic</a>
                <a className="mr-5 hover:text-gray-900">Campus Life</a>
              </nav>
              <button className="inline-flex items-center bg-yellow-500 border-0 py-1 px-3 focus:outline-none hover:bg-yellow-600 rounded text-base mt-4 md:mt-0">
                Apply Now
                <svg
                  fill="none"
                  stroke="currentColor"
            ...
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
              <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                ...
                <p className="mb-8 leading-relaxed">
                  Lovely Professional University is a premier university of
                  India with a global outlook. It is recognized by UGC, approved
                  by AICTE and has been ranked high by various outer agencies.
                </p>
              ...
              <div className="h-full">
                <img
                  className=" h-full"
                  alt="hero"
                  src="https://www.lpu.in/lpu-assets/images/home-slider/slide-overall-champion.jpg"
                  style={{
                    objectFit: 'contain',
                    height: '400px',
                  }}
          ...
          <section className="text-gray-700 body-font overflow-hidden border-t border-gray-200">
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
              ...
              <div className="flex lg:w-3/4 w-full flex-wrap lg:border border-gray-300 rounded-lg">
                ...
                <div className="lg:w-1/3 lg:-mt-px w-full mb-10 lg:mb-0 border-2 rounded-lg border-yellow-500 relative">
            ...
            <div className="container px-5 py-24 mx-auto">
              <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                ...
                <p className="leading-relaxed text-lg">
                  ...
                  master cleanse direct trade yellow juice before they sold out
                  gentrify plaid gastropub normcore XOXO 90s pickled cyellow
                  jean shorts. Slow-carb next level shoyellowitch ethical
          ...
          <section className="text-gray-700 body-font relative">
            ...
            <div className="container px-5 py-24 mx-auto flex">
              <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10">
                ...
                <input
                  className="bg-white rounded border border-gray-400 focus:outline-none focus:border-yellow-500 text-base px-4 py-2 mb-4"
                  placeholder="Email"
                  type="email"
                />
                <textarea
                  className="bg-white rounded border border-gray-400 focus:outline-none h-32 focus:border-yellow-500 text-base px-4 py-2 mb-4 resize-none"
                  placeholder="Message"
                  defaultValue={''}
                />
            ...
            <div className="border-t border-gray-200">
              <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
                <div className="flex md:flex-no-wrap flex-wrap justify-center md:justify-start">
                  <input
                    className="sm:w-64 w-40 bg-gray-100 rounded sm:mr-4 mr-2 border border-gray-400 focus:outline-none focus:border-yellow-500 text-base py-2 px-4"
